...
const TimeClock = /*#__PURE__*/React.forwardRef(function TimeClock(inProps, ref) {
  ...
  const handleValueChange = (0, _useEventCallback.default)((newValue, selectionState) => {
    setValue(newValue);
  ...
  } = (0, _dateHelpersHooks.useMeridiemMode)(selectedTimeOrMidnight, ampm, setValueAndGoToNextView);
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(TimeClockRoot, (0, _extends2.default)({
    ...
    children: [showViewSwitcher && /*#__PURE__*/(0, _jsxRuntime.jsx)(TimeClockArrowSwitcher, {
