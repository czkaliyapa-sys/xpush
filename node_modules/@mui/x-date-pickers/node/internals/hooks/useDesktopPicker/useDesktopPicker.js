...
const useDesktopPicker = ({
  ...
  const inputAdornmentProps = (0, _utils.useSlotProps)({
  ...
  const _useSlotProps = (0, _utils.useSlotProps)({
    ...
    openPickerButtonProps = (0, _objectWithoutPropertiesLoose2.default)(_useSlotProps, _excluded);
  ...
  const renderPicker = () => /*#__PURE__*/(0, _jsxRuntime.jsx)(_LocalizationProvider.LocalizationProvider, {
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_WrapperVariantContext.WrapperVariantContext.Provider, {
      value: "desktop",
