...
exports.validateSections = exports.splitFormatIntoSections = exports.mergeDateIntoReferenceDate = exports.isFourDigitYearFormat = exports.isAndroid = exports.getSectionsBoundaries = exports.getSectionVisibleValue = exports.getSectionOrder = exports.getDaysInWeekStr = exports.getDateSectionGetterAndSetter = exports.getDateSectionConfigFromFormatToken = exports.getDateFromDateSections = exports.doesSectionHaveTrailingZeros = exports.createDateStrForInputFromSections = exports.cleanTrailingZeroInNumericSectionValue = exports.cleanString = exports.clampDaySection = exports.changeSectionValueFormat = exports.applyWeekDayChange = exports.applyMeridiemChange = exports.adjustInvalidDateSectionValue = exports.adjustDateSectionValue = exports.addPositionPropertiesToSections = void 0;
    ...
    case 'weekDay':
      {
        ...
        const newDayInWeek = (currentDayInWeek + formattedDaysInWeek.length + delta) % formattedDaysInWeek.length;
...
exports.isFourDigitYearFormat = isFourDigitYearFormat;
const doesSectionHaveTrailingZeros = (utils, contentType, dateSectionName, format) => {
...
exports.doesSectionHaveTrailingZeros = doesSectionHaveTrailingZeros;
...
const getSectionsBoundaries = utils => {
  ...
  return {
    ...
    hours: ({
      ...
      const hasMeridiem = utils.formatByString(utils.endOfDay(today), format) !== hoursInDay.toString();
      return {
        minimum: 0,
...
const applyMeridiemChange = (utils, date, sectionValue) => {
 ...
 */
exports.applyMeridiemChange = applyMeridiemChange;
const applyWeekDayChange = (utils, date, sectionFormat, sectionValue) => {
...
exports.applyWeekDayChange = applyWeekDayChange;
const getDateSectionGetterAndSetter = (utils, dateSectionName) => {
...
exports.getDateSectionGetterAndSetter = getDateSectionGetterAndSetter;
const cleanTrailingZeroInNumericSectionValue = (utils, format, value) => {
    ...
    if (!shouldLimitToEditedSections || section.edited) {
      if (section.dateSectionName === 'meridiem') {
        ...
        const {
          getter,
          setter
        } = getDateSectionGetterAndSetter(utils, section.dateSectionName);
