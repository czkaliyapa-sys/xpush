...
const useField = params => {
      ...
      case ['ArrowUp', 'ArrowDown', 'Home', 'End', 'PageUp', 'PageDown'].includes(event.key):
        {
          ...
          updateSectionValue({
            ...
            setSectionValueOnDate: activeDate => {
              let date = (0, _useField.adjustDateSectionValue)(utils, activeDate, activeSection.dateSectionName, event.key);
            ...
            setSectionValueOnSections: () => ({
              sectionValue: (0, _useField.adjustInvalidDateSectionValue)(utils, activeSection, event.key),
              shouldGoToNextSection: false
            })
          });
          break;
  ...
  return (0, _extends2.default)({}, otherForwardedProps, {
    value: valueStr,
    inputMode,
    readOnly,
