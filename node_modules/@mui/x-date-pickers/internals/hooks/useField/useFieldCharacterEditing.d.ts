import { FieldSection } from './useField.types';
 ...
 */
export declare const useFieldCharacterEditing: <TDate, TSection extends FieldSection>({ sections, updateSectionValue, }: UseFieldEditingParams<TDate, TSection>) => {
