...
export var useFieldState = function useFieldState(params) {
  ...
  var _React$useState = React.useState(function () {
    ...
    sectionOrder = _React$useState2[0],
    setSectionOrder = _React$useState2[1];
  ...
  var selectedSectionIndexes = React.useMemo(function () {
    ...
    if (typeof selectedSections === 'string') {
      var selectedSectionIndex = state.sections.findIndex(function (section) {
        return section.dateSectionName === selectedSections;
      });
      return {
  ...
  var updateSectionValue = function updateSectionValue(_ref3) {
    var activeSection = _ref3.activeSection,
      setSectionValueOnDate = _ref3.setSectionValueOnDate,
      setSectionValueOnSections = _ref3.setSectionValueOnSections;
    var commit = function commit(commitParams) {
      ...
      var shouldGoToNextSection = commitParams.shouldGoToNextSection,
        shouldPublish = commitParams.shouldPublish,
        values = commitParams.values,
        sections = commitParams.sections;
    ...
    if (activeDateManager.activeDate != null && utils.isValid(activeDateManager.activeDate)) {
      var validDateResponse = setSectionValueOnDate(activeDateManager.activeDate, sectionsValueBoundaries);
    ...
    var invalidDateResponse = setSectionValueOnSections(sectionsValueBoundaries);
    if (invalidDateResponse == null) {
      // The section was not updated
      return commit(null);
    }
    var newSections = setSectionValue(selectedSectionIndexes.startIndex, invalidDateResponse.sectionValue);
    ...
    if (!utils.isValid(newDate) && activeDateSections.every(function (section) {
      return section.dateSectionName === 'weekDay' || section.value !== '';
