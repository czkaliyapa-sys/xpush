...
var _excluded = ["onClick", "onKeyDown", "onFocus", "onBlur", "onMouseUp", "onPaste"];
...
import { adjustDateSectionValue, adjustInvalidDateSectionValue, isAndroid, cleanString } from './useField.utils';
...
export var useField = function useField(params) {
      ...
      case ['ArrowUp', 'ArrowDown', 'Home', 'End', 'PageUp', 'PageDown'].includes(event.key):
        {
          ...
          updateSectionValue({
            ...
            setSectionValueOnDate: function setSectionValueOnDate(activeDate) {
              var date = adjustDateSectionValue(utils, activeDate, activeSection.dateSectionName, event.key);
            ...
            setSectionValueOnSections: function setSectionValueOnSections() {
              return {
                sectionValue: adjustInvalidDateSectionValue(utils, activeSection, event.key),
                shouldGoToNextSection: false
              };
            }
          });
  ...
  return _extends({}, otherForwardedProps, {
    value: valueStr,
    inputMode: inputMode,
    readOnly: readOnly,
