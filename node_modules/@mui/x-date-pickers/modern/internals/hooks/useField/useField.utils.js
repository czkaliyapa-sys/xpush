...
export const getSectionVisibleValue = (section, willBeRenderedInInput) => {
...
export const isFourDigitYearFormat = (utils, format) => utils.formatByString(utils.date(), format).length === 4;
export const doesSectionHaveTrailingZeros = (utils, contentType, dateSectionName, format) => {
 ...
 */
export const applyMeridiemChange = (utils, date, sectionValue) => {
 ...
 */
export const applyWeekDayChange = (utils, date, sectionFormat, sectionValue) => {
...
export const getDateSectionGetterAndSetter = (utils, dateSectionName) => {
...
export const cleanTrailingZeroInNumericSectionValue = (utils, format, value) => {
...
export const mergeDateIntoReferenceDate = (utils, date, sections, referenceDate, shouldLimitToEditedSections) => {
