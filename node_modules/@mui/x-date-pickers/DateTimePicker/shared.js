...
export function useDateTimePickerDefaultizedProps(props, name) {
  var _themeProps$ampm, _themeProps$slots, _themeProps$slotProps, _themeProps$orientati, _themeProps$ampmInClo, _themeProps$disableIg, _themeProps$disableFu, _themeProps$disablePa, _themeProps$minDateTi, _themeProps$maxDateTi, _themeProps$minDateTi2, _themeProps$maxDateTi2;
  ...
  return _extends({}, themeProps, applyDefaultViewProps({
    ...
    ampmInClock: (_themeProps$ampmInClo = themeProps.ampmInClock) != null ? _themeProps$ampmInClo : true,
