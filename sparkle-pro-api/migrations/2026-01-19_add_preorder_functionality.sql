-- Migration: Add Pre-order Functionality
-- Date: 2026-01-19
-- Purpose: Enable automatic pre-order mode when all variants reach zero stock

-- ==========================================
-- PART 1: Add is_pre_order column to gadgets table
-- ==========================================

ALTER TABLE `gadgets` 
ADD COLUMN `is_pre_order` TINYINT(1) DEFAULT 0 AFTER `in_stock`;
...
-- ==========================================
-- PART 3: Update existing gadgets to set initial pre-order status
-- ==========================================
